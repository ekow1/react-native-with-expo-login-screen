...
export default function Page() {
  return (
    <View style={styles.container}>
      <Text style={styles.text}>Fill in your details to register</Text>
      ...
      <View style={styles.main}>
        <TextInput style={styles.input} placeholderTextColor="#000" placeholder=" password  again ....." autoCapitalize="none" secureTextEntry={true} /*value="username" */ />
